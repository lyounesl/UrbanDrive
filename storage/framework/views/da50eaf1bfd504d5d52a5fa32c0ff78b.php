<?php $__env->startSection('title', 'Réserver une course - Urban Drive'); ?>
...
<div class="reservation-container">
    ...
    <div class="reservation-content">
        ...
        <form method="POST" action="<?php echo e(route('reservationClt', ['num' => $num])); ?>" id="reservationForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="adresse_depart"
                               value="<?php echo e(old('adresse_depart')); ?>" required
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="adresse_arrivee"
                               value="<?php echo e(old('adresse_arrivee')); ?>" required
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control"
                               name="date_depart_souhaitee" min="<?php echo e(date('Y-m-d\TH:i')); ?>"
                               value="<?php echo e(old('date_depart_souhaitee')); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Nombre de passagers *</label>
                        <select class="form-control" name="nombre_passagers" required>
                            <?php for($i = 1; $i <= 8; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(old('nombre_passagers', 1) == $i ? 'selected' : ''); ?>>
                                    <?php echo e($i); ?> passager(s)
                                </option>
                            <?php endfor; ?>
                        </select>
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="vehicules-grid">
                    <?php $__currentLoopData = $vehicules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="vehicule-option <?php echo e(old('type_vehicule', 'standard') === $type ? 'selected' : ''); ?>"
                             data-type="<?php echo e($type); ?>" onclick="selectVehicule('<?php echo e($type); ?>')">
                            <div class="vehicule-emoji"><?php echo e($info['emoji']); ?></div>
                            <div class="vehicule-nom"><?php echo e($info['nom']); ?></div>
                            <div class="vehicule-desc"><?php echo e($info['desc']); ?></div>
                            <div class="vehicule-prix"><?php echo e(number_format($tarifs[$type], 2, ',', ' ')); ?> €/km</div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <input type="hidden" name="type_vehicule" id="type_vehicule"
                       value="<?php echo e(old('type_vehicule', 'standard')); ?>">
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="notes_client"
                              placeholder="Ex: Bagages volumineux, arrêt intermédiaire, besoin d'aide..."><?php echo e(old('notes_client')); ?></textarea>
                </div>
            </div>
...
<script>
    const tarifs = <?php echo json_encode($tarifs, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ahmed/UrbanDrive/resources/views/reservationClient.blade.php ENDPATH**/ ?>