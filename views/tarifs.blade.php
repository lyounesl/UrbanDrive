...
<body>
        ...
        <div class="tarifs-content">
            ...
            <div class="pricing-grid">
                <div class="pricing-card">
                    ...
                    <a href="/reservation" class="btn-pricing">Choisir cette offre</a>
                </div>
            ...
            <div class="tarifs-table">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Supplément nuit (22h-6h)</td>
                            <td>+2,00€</td>
                            <td>+2,00€</td>
                            <td>+2,00€</td>
                        </tr>
                        <tr>
                            <td>Supplément aéroport</td>
                            <td>+4,00€</td>
                            <td>+4,00€</td>
                            <td>+4,00€</td>
                        </tr>
                        <tr>
                            <td>Supplément gare</td>
                            <td>+3,00€</td>
                            <td>+3,00€</td>
                            <td>+3,00€</td>
                        </tr>
                        <tr>
                            <td>Heure d'attente</td>
                            <td>25,00€</td>
                            <td>30,00€</td>
                            <td>40,00€</td>
                        </tr>
                        <tr>
                            <td>Annulation (avant 30min)</td>
                            <td>Gratuit</td>
                            <td>Gratuit</td>
                            <td>Gratuit</td>
                        </tr>
                         <tr>
                            <td>Annulation (après 30min)</td>
                            <td>4.50€</td>
                            <td>4.50€</td>
                            <td>4.50€</td>
                        </tr>
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-section">
                <h3>UrbanDrive</h3>
                <p>Service VTC disponible 24h/24 et 7j/7. Voyagez avec style et sécurité.</p>
            </div>
    ...
    <script>
        ...
        function calculateCost() {
            ...
            document.getElementById('cost-details').textContent = `Pour ${distance} km avec ${vehicleType.split(' (')[0]}`;
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Événements pour le calculateur
